...
<html>
    ...
    <body>
        <nav class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<%=path %>/message/list.do">
                        返回留言板
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="<%=path %>/editUserPrompt.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input  name="birthday"  class="form-control"  id="birthday" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${user.birthday}"/> "  readonly>
