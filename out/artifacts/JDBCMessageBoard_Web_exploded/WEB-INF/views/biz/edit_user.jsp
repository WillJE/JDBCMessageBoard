<%@page import="com.imooc.jdbc.bean.User"%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="<%=path %>/editUser.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="birthday" class="form-control" id="birthday" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${user.birthday}"/>">
                    </div>
                </div>
                <div class="form-group">
